...
$(".mrsmarfixed button:eq(0)").on("click", function () {
    ...
    smartdata = "<table class='wikijanatable'><caption>" + sphonename + "</caption><thead><tr><th>Name : </th><th>" + sphonename + "</th></tr></thead><tbody>" + smartdata + "</tbody></table><span><!--more--></span>";
    ...
    qnamakermrl1 += '{ "@type": "Question",  "name": "who is the owner of WikiJana ? ", "acceptedAnswer": {  "@type": "Answer",  "text": "<b> WikiJana</b> is founded by <b>Samrat Raihan</strong>. " } } ] } </script>';
    var mainschema = '<script type="application/ld+json"> { "@context": "https://schema.org/", "@type": "Review",  "itemReviewed": { "@type": "Product", "name": "' + sphonename + '", "review": { "@type": "Review", "author": { "@type": "Person",  "name": "WikiJana" },  "inLanguage": "en"	 }, "image": {  "@type": "ImageObject", "url": "<data:blog.postImageThumbnailUrl/>", "height":"700",  "width": "1280" } }, "name": "' + sphonename + ' long-term review", "author": {  "@type": "Person",  "name": "WikiJana" }, "datePublished": "<data:post.timestamp/>" }</script>'

    $(".smartoutput textarea").val(thumpimg + smarttext + smartdata + mainschema + moresmrtdata + smtvurl + qnamakermrl1 + qnamakermrl2 + "<style>:root{--bgcolor:black;}.wikijanatable{border:1px solid var(--bgcolor);width:100%;height:auto;border-collapse:separate}.wikijanatable caption{text-align:center;border-top:1px solid var(--bgcolor);font-size:20px;font-weight:700}.wikijanatable td,.wikijanatable tr{border:1px solid var(--bgcolor);padding:7px;border-collapse:separate;font-family:'Font Awesome 5 Pro'}.wikijanatable th{font-size:20px;font-family:Oswald;text-align:center}</style>")
    $("body").append();
})
